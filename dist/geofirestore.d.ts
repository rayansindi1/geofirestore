...
export declare class GeoFirestore {
     ...
     */
    constructor(_collectionRef: firestore.CollectionReference);
    /********************/
    /********************/
    /**
     ...
     */
    add(document: any, customKey?: string): Promise<firestore.DocumentReference>;
    /**
     ...
     * @returns A promise that is fulfilled when the write is complete.
     */
    set(keyOrDocuments: string | any, document?: any, customKey?: string): Promise<void>;
    /**
     ...
     */
    static distance(location1: firestore.GeoPoint, location2: firestore.GeoPoint): number;
}
