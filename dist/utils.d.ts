 ...
 * @param flag Tells function to send up boolean if valid instead of throwing an error.
 */
export declare function validateLocation(location: firestore.GeoPoint, flag?: boolean): boolean;
/**
 ...
 */
export declare function encodeGeohash(location: firestore.GeoPoint, precision?: number): string;
/**
 ...
 */
export declare function boundingBoxBits(coordinate: firestore.GeoPoint, size: number): number;
/**
 ...
 */
export declare function boundingBoxCoordinates(center: firestore.GeoPoint, radius: number): firestore.GeoPoint[];
/**
 ...
 */
export declare function geohashQueries(center: firestore.GeoPoint, radius: number): string[][];
/**
 ...
 */
export declare function encodeGeoFireObject(location: firestore.GeoPoint, geohash: string, document: any): GeoFirestoreObj;
/**
 ...
 */
export declare function geoFirestoreGetKey(snapshot: firestore.DocumentSnapshot): string;
/**
 ...
 */
export declare function toGeoPoint(latitude: number, longitude: number): firestore.GeoPoint;
