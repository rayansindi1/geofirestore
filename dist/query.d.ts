...
export declare class GeoFirestoreQuery {
     ...
     */
    constructor(_collectionRef: firestore.CollectionReference, queryCriteria: QueryCriteria);
    /********************/
    /********************/
    /**
     ...
     */
    private _cancelGeohashQuery(queryState);
    /**
     ...
     */
    private _fireCallbacksForKey(eventType, key, document?, distanceFromCenter?);
    /**
     ...
     */
    private _removeLocation(key, document?);
    /**
     ...
     */
    private _updateLocation(key, location?, document?, modified?);
}
